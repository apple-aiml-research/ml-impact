...
@register_template
class EngVerbPluralityAgreementIndicative(TemplateBase):
    """Generate data for noun-verb (indicative) agreement in English sentences based on plurality."""
    ...
    def _create_correct_judgments(
        ...
        Args:
            ...
            verb_features (Dict): Features of the verb (e.g. plurality).
