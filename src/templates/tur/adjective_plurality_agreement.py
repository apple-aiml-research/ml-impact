...
@register_template
class TurAdjectivePluralityAgreement(TemplateBase):
    """Generates data for noun-adjective agreement in Turkish sentences based on plurality. Case
    does not affect the adjective."""

    def __init__(self):
        self.setup_common(
            template_name="adjective_plurality_agreement.j2", lang_code="tur"
        )
    ...
    def _apply_correct_inflection_logic(self, features_dict: Dict) -> Dict:
        ...
        if "case" in adj_feature_fict:
            del adj_feature_fict["case"]
        adj_feature_fict["plurality"] = "SG"
