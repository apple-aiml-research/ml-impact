...
@register_template
class TurVerbPluralityAgreementIndicative(TemplateBase):
    """Generate data for noun-verb (indicative) agreement in Turkish sentences based on plurality."""

    def __init__(self):
        self.setup_common(
            template_name="verb_plurality_agreement_indicative.j2",
            lang_code="tur",
        )
        ...
        # Cache base indicative verbs
        self.base_indicative_verbs = self.placeholders.get_by_features(
    ...
    def _generate_generation(self, additional_instruction: str = "") -> List[Dict]:
        ...
        for feature_combination in feature_combinations:
            ...
            if verb_features["tense"] == "PRS":
                verb_features["aspect"] = "PROG"
            elif verb_features["tense"] == "PST":
                verb_features["aspect"] = "PFV"
            ...
            for name_group in name_groups:
                ...
                for root_verb in self.base_indicative_verbs:
                    ...
                    if verb_feature_filter["tense"] == "PRS":
                        tense = "present"
                    elif verb_feature_filter["tense"] == "PST":
                        tense = "past"
                    else:
                        tense = ""
                    if tense:
                    ...
                    additional_instruction += " Do not use the habitual form."
    ...
    def _create_correct_judgments(
        ...
        Args:
            noun_features (Dict): Features of the noun (e.g. plurality, name).
            root_verb (str): The root form of the verb.
            verb_features (Dict): Features of the verb (e.g. plurality, aspect).
    ...
    def _create_incorrect_judgments(
        ...
        Args:
            noun_features (Dict): Noun features (name, plurality).
            root_verb (str): Root form of the verb.
            verb_features (Dict): Verb features (plurality).
            ...
            exclude_features (Dict, optional): Features to exclude (single values or lists).
