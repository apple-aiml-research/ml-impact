...
@register_template
class FinnVerbPluralityAgreementImperative(TemplateBase):
    """Generate data for noun-verb (imperative) agreement in Finnish sentences based on plurality."""
        ...
        for feature_combination in feature_combinations:
            ...
            for name_group in name_groups:
                ...
                for root_verb in self.base_imperative_verbs:
                    ...
                    additional_instruction = (
                        additional_instruction + " and address a single person."
                        if noun_plurality == "SG"
                        else additional_instruction + "."
                    )
    ...
    def _generate_judgment(self, additional_instruction: str = "") -> List[Dict]:
        ...
        for feature_combination in feature_combinations:
            ...
            noun_plurality = verb_features["plurality"]  # verb agrees with noun
            additional_instruction = (
                "The inflected verb should address a single person."
                if noun_plurality == "SG"
                else ""
            )
