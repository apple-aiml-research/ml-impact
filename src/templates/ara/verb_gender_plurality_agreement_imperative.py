...
@register_template
class AraVerbGenderPluralityAgreementImperative(TemplateBase):
    """Generates data for noun-verb agreement in Arabic imperative sentences based on gender and plurality."""
