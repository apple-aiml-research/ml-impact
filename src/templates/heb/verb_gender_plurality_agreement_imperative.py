...
@register_template
class HebVerbGenderPluralityAgreementImperative(TemplateBase):
    """Generates data for noun-verb agreement in Hebrew imperative sentences based on gender and plurality."""
            ...
            for name_group in name_groups:
                ...
                for root_verb in self.base_imperative_verbs:
                    ...
                    inflected_forms = self.get_inflected_forms(
                        "verbs", verb_feature_filter, ok_empty=True
                    )
