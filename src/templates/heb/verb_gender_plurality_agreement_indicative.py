...
@register_template
class HebVerbGenderPluralityAgreementIndicative(TemplateBase):
    """Generate data for noun-verb (indicative) agreement in Hebrew sentences based on gender and plurality."""
